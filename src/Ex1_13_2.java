...
public class Ex1_13_2 {
	public static void main (String[] args) {
		...
		switch(type) {
		case 1:
			System.out.print("あなたは几帳面な性格の方ですよね？");
			break;
		case 2:
			System.out.print("あなたはマイペースな性格の方ですね？");
			break;
		case 3:
			System.out.print("あなたは大雑把な性格ですね？");
			break;
		case 4:
			System.out.print("あなたは天才肌な方ですね？");
			break;
		default:
			System.out.print("数字の1～4で答えてください");
			break;
		}
